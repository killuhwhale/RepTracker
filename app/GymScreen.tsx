...
import { GymCardProps } from "../src/app_components/Cards/types";
...
import { GymClassSquares } from "../src/app_components/Grids/Gyms/GymClassSquares";
...
const GymScreen: FunctionComponent<Props> = ({
  navigation,
  route: { params },
}) => {
